...
/*
 * ?t = (65536 - startwert)*PS*02탎
 * PreScaler = 1:64
 * Startwert = 35536
 * ?t = (65536 - 35536)*(64)*02탎 = 65535,54탎 = 65.535ms
 * 
 * 
 * 
 * ?t = (65536 - startwert)*PS*02탎 = 0.500
 * 
 * (65536 - startwert) = 0.500 / (PS*02탎)
 * startwert = 65536 - (0.500 / (PS*02탎))
 * 26473.5 = 65536 - (0.500 / (64*02탎)) ~ 26473 = 0x6769
 */